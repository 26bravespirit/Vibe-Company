...
### S18 · "我不知道怎么开始"（初学者专属）
**Root cause:** 第一次用AI协作，不知道怎么发起对话。
| Priority | Technique | Why | Do This Now |
|----------|-----------|-----|-------------|
| ★★★ | T03 先看再改 | 从一个简单的大纲请求开始，不要一上来就写完整文档 | 说："帮我列一个[主题]的大纲，先不要写正文" |
| ★★ | T05 内容与格式分离 | 先想清楚要说什么，别管格式 | 说："我要写一个关于[X]的[文档类型]，帮我梳理核心要点" |
| ★ | Mode 2 (Plan) | 如果是大项目，先规划 | 切换到 Mode 2 让教练帮你规划 |

### S19 · "AI写的东西感觉不像我"（初学者常见）
**Root cause:** 没有给AI足够的个人风格指引，AI用了通用风格。
| Priority | Technique | Why | Do This Now |
|----------|-----------|-----|-------------|
| ★★★ | T04 提示词即内容 | 如果你知道自己想说什么，直接写出来让AI润色 | 用你自己的话写一段，说："保持我的语气，只帮我理顺逻辑和补充细节" |
| ★★ | T14 自己做选择 | 当AI给出不像你的表达时，指出来并给出你的版本 | 说："这段不像我说话的风格，我会这样说：[你的版本]。按这个方向改" |
| ★ | T01 范式级指令 | 在开始前就定义你的风格 | 说："我的写作风格是[描述]。所有输出都要符合这个风格" |

### S20 · "我不确定什么时候算完了"（初学者常见）
**Root cause:** 没有明确的"完成标准"，不知道迭代到什么程度可以停。
| Priority | Technique | Why | Do This Now |
|----------|-----------|-----|-------------|
| ★★★ | T06 让AI挑毛病 | 让AI做最后一次检查，如果只有小问题，就可以交了 | 说："假装你是最挑剔的审稿人，这份文档能打几分？" |
| ★★ | T16 交付前验证 | 做一次一致性检查就够了 | 说："检查全文有没有前后矛盾的地方" |
| ★ | T11 换个角度看 | 如果不确定，用三个角度最后看一遍 | 说："从三个角度给这份文档打分：创意、严谨、实用" |
