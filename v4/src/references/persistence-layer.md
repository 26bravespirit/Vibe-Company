...
coaching_action: ""                 # review / plan / assist / navigate / prescribe / reduce / beginner_guide
skill_level: null                   # v4新增: beginner / intermediate / skilled / expert / null（未知）
coaching_hooks_triggered: []        # v4新增: 本次触发的教练提示（Acceptance Loop / No Verification / Perfectionism Spiral / Format Fixation）
graduated: false                    # v4新增: 本次会话是否触发了等级升级
---
...
| 字段 | Mode 0 | Mode 1 | Mode 2 | Mode 3 | Mode 4 | Mode 5 | Mode 6 |
|------|--------|--------|--------|--------|--------|--------|--------|
| scores (D1-D6) | ✅ | — | — | — | — | — |
| saturation_index | — | — | — | — | — | ✅ |
| techniques_used | ✅ | ✅ | ✅ | — | ✅ | ✅ |
