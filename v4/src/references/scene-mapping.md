...
| **初学者首次创作** | T03, T06, T11, T14, T15 | 5/25 (Core 5) | 先看再改 + 让AI挑毛病 + 自己做选择 | N/A（新手阶段不使用Navigate） |
| **日常文档/邮件** | T03, T04, T05, T14 | 4/25 (Light) | 内容格式分离 + 先看再改 | N/A（轻量场景） |
| **会议纪要/总结** | T03, T05, T13, T15 | 4/25 (Light) | 萃取关键信息 + 渐进式修正 | N/A（轻量场景） |
